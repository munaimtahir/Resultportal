...
class ExamAggregateComputationTests(TestCase):
    ...
    def setUp(self):
        ...
        self.student1 = Student.objects.create(
            year_class=self.year_class,
            roll_number="001",
            official_email="student1@example.com"
        )
        self.student2 = Student.objects.create(
            year_class=self.year_class,
            roll_number="002",
            official_email="student2@example.com"
        )
...
class ComponentAggregateComputationTests(TestCase):
    ...
    def test_compute_component_aggregates(self):
        ...
        theory_agg = next((a for a in aggregates if a.component == ComponentAggregate.Component.THEORY), None)
        self.assertIsNotNone(theory_agg)
        self.assertEqual(theory_agg.mean_score, Decimal("70.00"))

        practical_agg = next((a for a in aggregates if a.component == ComponentAggregate.Component.PRACTICAL), None)
