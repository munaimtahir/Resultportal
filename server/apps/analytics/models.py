...
class ComparisonAggregate(models.Model):
    ...
    current_exam = models.ForeignKey(
        Exam, on_delete=models.CASCADE, related_name="comparison_as_current"
    )
    previous_exam = models.ForeignKey(
        Exam, on_delete=models.CASCADE, related_name="comparison_as_previous", null=True, blank=True
    )
